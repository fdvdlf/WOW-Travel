...
const testimonialImg = "/images/h3_testimonial_img.jpg";
const reviewShape = "/images/review_shape.svg";
const starIcon = "/icon/star.svg";
const petIcon = "/icon/pet_icon02.svg";
const authorImg = "/images/h3_testi_author01.png";
const quoteIcon = "/icon/quote.svg";
const arrowIcon = "/icon/right_arrow03.svg";
const testimonialShape = "/images/h3_testimonial_shape.png";
